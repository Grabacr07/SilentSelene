...
namespace MetroTrilithon.Serialization
{
    ...
    public abstract class SerializablePropertyBase<T> : INotifyPropertyChanged
    {
        ...
        protected SerializablePropertyBase(string key, ISerializationProvider provider, [AllowNull] T defaultValue)
        {
        ...
        protected virtual void OnValueChanged([AllowNull] T oldValue, T newValue)
        {
